...
const HomePage: React.FC<HomePageProps> = ({
  ...
  return (
    <div className="space-y-8 sm:space-y-16">
      {/* Indigo Part */}
      <section className="text-center pt-16 sm:pt-20 lg:pt-32 mt-4 sm:mt-6 pb-12 sm:pb-20 bg-gradient-to-br from-indigo-800 to-indigo-300 rounded-xl sm:rounded-2xl mx-0 sm:mx-0 lg:mx-[-5rem] xl:mx-[-10rem] 2xl:mx-[-15rem]">
